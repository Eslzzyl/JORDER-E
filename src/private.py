# copied from https://github.com/pytorch/pytorch/blob/v1.1.0/torch/utils/data/dataloader.py#L199
# _DataLoaderIter is a privagte class in pytorch, however the author imported this class in dataloader.py
# And now _DataLoaderIter is deprecated
